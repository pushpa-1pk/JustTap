...
export const API_BASE_URLS = {
  ...
  bookings: import.meta.env.VITE_BOOKING_API_URL || 'http://localhost:3001/api/v1',
...
export const ENDPOINTS = {
  ...
  bookings: {
    admin: {
      ...
      disputes: '/admin/bookings/disputes',
      disputeDetail: (id: string) => `/admin/bookings/disputes/${id}`,
      resolveDispute: (id: string) => `/admin/bookings/disputes/${id}/resolve`,
      disputeThread: (id: string) => `/admin/bookings/disputes/${id}/thread`,
      sendDisputeMessage: (id: string) => `/admin/bookings/disputes/${id}/messages`,
    },
